...
"[project]/src/pages/api/registration/register.js [api] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        for (const importPath of paths){
            try {
                const module = await __turbopack_context__.f({
                    "../../../models/Registration": {
                        id: ()=>"[project]/src/models/Registration.js [api] (ecmascript, async loader)",
                        module: ()=>__turbopack_context__.r("[project]/src/models/Registration.js [api] (ecmascript, async loader)")(__turbopack_context__.i)
                    },
                    "../../../models/Registration.js": {
                        id: ()=>"[project]/src/models/Registration.js [api] (ecmascript, async loader)",
                        module: ()=>__turbopack_context__.r("[project]/src/models/Registration.js [api] (ecmascript, async loader)")(__turbopack_context__.i)
...
const connectDB = async ()=>{
    try {
        ...
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connections[0].readyState === 1) {
            console.log('Using existing MongoDB connection');
            return __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connections[0];
        }
        // Check if connecting
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connections[0].readyState === 2) {
            console.log('MongoDB connection is connecting...');
            // Wait for connection to complete
            await new Promise((resolve)=>{
                __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connections[0].on('connected', resolve);
            });
            return __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connections[0];
        }
        ...
        const connection = await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].connect(process.env.MONGODB_URI, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f31d878._.js.map